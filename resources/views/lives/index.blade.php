...
<div class="column justify-content-center ms-5 me-5">
    <h1 class="text-center mt-3">All Lives</h1>
    <a href="{{ url ('/inputlives') }}"><button class="btn btn-outline-secondary" type="button" id="tes">Input Lives</button></a>
    <hr>
</div>
@include('lives.script')
